...
?>
<script id='dsq-count-scr' src='//YOUR-DISQUS-FORUM.disqus.com/count.js' async></script>
	...
	if($this->pagination->total > 0) : ?>
		...
		<table class="list stripe">
			...
			?>
				...
				<td class="disqus" style="width:45px; text-align:center;">
                <!-- load js -->
                <?php echo "<span class='disqus-comment-count' data-disqus-url='http://".$_SERVER['HTTP_HOST']."/item/".$row->alias.".html'></span>"?>
                </td>
					<td class="type">
